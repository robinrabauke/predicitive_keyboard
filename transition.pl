...
transition(start, 		[ich, du , das], 					[0.4, 0.9 ,1.0]).
transition(ich, 		[habe, bin, laufe], 				[0.4, 0.9 ,1.0]).
transition(habe, 		[durst, lust, urlaub], 				[0.4, 0.9 ,1.0]).
transition(bin, 		[schoen, traurig, klug], 			[0.3, 0.9 ,1.0]).
transition(laufe, 		[rechts, links, heim], 				[0.8, 0.9 ,1.0]).
...
transition(kind,		[ist, wird, war], 					[0.7, 0.9 ,1.0]).
transition(wetter,		[ist, wird, war], 					[0.7, 0.9 ,1.0]).
transition(essen,		[ist, wird, war], 					[0.7, 0.9 ,1.0]).
